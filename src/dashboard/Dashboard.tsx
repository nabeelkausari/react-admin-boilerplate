...
const Dashboard = () => {
  // Using ErrorBoundary components to handle errors in child components
        ...
        <div style={styles.rightCol}>
          <div style={styles.flex}>
            <ErrorBoundary fallback={
              <div style={{ padding: '16px', minHeight: '248px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
